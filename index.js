...
const pwaProxy = createProxyMiddleware({ target: `http://localhost:3003`, ws: true });
const magentoProxy = createProxyMiddleware({ target: `http://${REMOTE_SERVER_DOMAIN}`, logLevel: "debug" });
